...
import { McpToolHandler, McpToolResult } from '@domain/calendar-tool.interface';
import {
  CreateEventTool,
  ListEventsTool,
  FindFreeSlotsTool,
...
export class McpController {
  ...
  constructor(
    ...
    findFreeSlots: FindFreeSlotsTool,
  ...
  @Get('health')
  health() {
    return { status: 'ok', service: 'calendar-mcp', tools: this.tools.size };
  }
