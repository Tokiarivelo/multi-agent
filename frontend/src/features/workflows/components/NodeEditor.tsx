              ...
              (() => {
                ...
                return (
                  <div className="space-y-4">
                    ...
                    <div className="rounded-md border border-indigo-500/20 bg-indigo-500/5 p-3 space-y-3">
                      ...
                      <div className="space-y-1.5">
                        <Label className="text-xs">
                          ...
                          <span className="text-muted-foreground font-normal ml-1">
                            ...
                            <code className="font-mono bg-muted px-1 rounded">
                              {'(output, iteration, results, context)'}
                            </code>
                          </span>
                        </Label>
                        <Input
                        ...
                        <p className="text-[10px] text-muted-foreground">
                          ...
                          <code className="font-mono bg-muted px-1 rounded">__DONE__</code> to stop
                          early.
                        </p>
                      </div>
                    </div>
                            ...
                            >
                              <div className="flex items-center gap-2">
                                ...
                                <Button
                                  ...
                                  className="h-8 w-8 text-destructive shrink-0"
                                  onClick={() => {
                                    const next = ((cfg.subAgents as SubAgentConfig[]) ?? []).filter(
                                      (_, i) => i !== idx,
                                    );
                                    handleConfigChange('subAgents', next);
                                  }}
                    ...
                    {/* Output shape */}
                    <div className="rounded-md bg-muted/30 border border-border/40 p-3 text-[11px] text-muted-foreground font-mono space-y-0.5">
                      <p className="font-semibold text-foreground/70 mb-1 font-sans">
                        Output shape:
                      </p>
                      <p>{'{'}</p>
                      <p className="pl-4">
                        output: any <span className="font-sans">{'// last iteration output'}</span>
                      </p>
                      <p className="pl-4">
                        iterations: number{' '}
                        <span className="font-sans">{'// how many loops ran'}</span>
                      </p>
                    ...
                    {mcpTools.length > 0 ? (
                      ...
                      <div className="rounded-lg border border-dashed border-border/60 py-6 text-center">
                        ...
                        <p className="text-xs text-muted-foreground/60 mt-1">
                          {t('workflows.node_editor.noMcpToolsHint') ||
                            'Add one from the Integrations → GitHub page.'}
                        </p>
                      </div>
                    )}
                  </div>
