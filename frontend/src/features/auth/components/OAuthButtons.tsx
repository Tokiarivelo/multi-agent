...
export default function OAuthButtons({ callbackUrl = '/dashboard', mode = 'signIn' }: OAuthButtonsProps) {
  const { t } = useTranslation();

  const dividerLabel =
    mode === 'signUp' ? t('auth.signUpWith') : t('auth.continueWith');
