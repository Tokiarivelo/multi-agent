export const common = {
  ...
  'API Keys': 'Clés API',
  'workspace.title': 'Espace de travail local',
  'workspace.description':
    'Sélectionnez un dossier local sur votre machine pour lire et éditer des fichiers directement dans le navigateur. Vos modifications restent sur votre machine.',
  'workspace.openFolder': 'Ouvrir un dossier local',
  'workspace.loading': 'Chargement...',
  'workspace.explorer': 'Explorateur',
  'workspace.close': "Fermer l'espace de travail",
  'workspace.refresh': "Rafraîchir l'arborescence",
  'workspace.noFile': 'Aucun fichier sélectionné',
  'workspace.saveBtn': 'Enregistrer',
  'workspace.saveTooltip': 'Enregistrer le fichier actuel',
  'workspace.opened': 'Espace de travail ouvert avec succès',
  'workspace.openError': "Impossible d'ouvrir l'espace de travail",
  'workspace.saved': 'Fichier enregistré avec succès',
  'workspace.saveError': "Impossible d'enregistrer le fichier",
  'workspace.readError': 'Impossible de lire le fichier',
  'workspace.unsavedChanges': 'Vous avez des modifications non enregistrées. Abandonner?',
  'workspace.terminal.title': 'TERMINAL',
  'workspace.terminal.label': 'Terminal',
  'workspace.terminal.toggle': 'Afficher/masquer le terminal',
  'workspace.terminal.clear': 'Effacer le terminal',
  'workspace.terminal.close': 'Fermer le terminal',
  'workspace.terminal.empty': 'Tapez "help" pour voir les commandes disponibles.',
  'workspace.terminal.placeholder': 'Entrez une commande...',
  ...
  auth: {
    ...
    orchestrateSubtitle: 'Rejoignez-nous pour orchestrer vos agents IA',
    signUp: 'S’inscrire',
    creatingAccount: 'Création du compte...',
    registrationFailed: 'Échec de l’inscription. Veuillez réessayer.',
    alreadyHaveAccount: 'Vous avez déjà un compte ?',
    signInLink: 'Se connecter',
    signUpWith: 'Ou s’inscrire avec',
    emailLabel: 'Email',
