export const workflows = {
  ...
  'workflows.editor.stop': 'Stop',
  'workflows.editor.cancelling': 'Cancelling…',
  ...
  'workflows.node_editor.descriptionPlaceholder': 'Describe what this node does…',
  'workflows.node_editor.whileCondition': 'Condition',
  'workflows.node_editor.whileMaxIterations': 'Max Iterations',
  'workflows.node_editor.switchOn': 'Switch On',
  'workflows.node_editor.switchCases': 'Cases',
  'workflows.node_editor.switchAddCase': 'Add case',
  ...
  'workflows.ai.provisioning': 'Provisioning agents & tools…',
  'workflows.ai.showJson': 'Show JSON',
  ...
  'workflows.nodeAi.pending': 'Config changes ready to apply',
  ...
  'workflows.waitingInput.oauthTitle': 'GitHub Permission Required',
  ...
  'workflows.agentReply.githubAuthDone': 'Connected — resuming…',
  'workflows.agentReply.githubPopupBlocked': 'Pop-up blocked — allow pop-ups and try again.',
  'workflows.fullscreen.viewFullscreen': 'View fullscreen',
  'workflows.fullscreen.copy': 'Copy',
  'workflows.fullscreen.copied': 'Copied!',
  'workflows.multiTurn.finalResponse': 'Final Response',
  'workflows.palette.tools_load_more': 'Load more',
  'workflows.palette.tools_loading_more': 'Loading...',
  'workflows.execution.disabledNodes':
    'Cannot run: the following node types are disabled — {{labels}}. Enable them in the Nodes page before running.',
  ...
  'workflows.forEach.maxIterHint': '(safety cap)',
  'workflows.forEach.contextTitle': 'Variables available inside each body iteration:',
